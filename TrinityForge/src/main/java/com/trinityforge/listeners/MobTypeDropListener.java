 ...
 *
 * <p>ランタイム検証必須（Bukkit EntityDeathEventに依存するため単体テスト不可。確率/個数の純粋ロジックは
 * {@link MobDropRoller} で単体テスト済み）。
 */
public final class MobTypeDropListener implements Listener {
    ...
    public void onDeath(EntityDeathEvent event) {
        ...
        int bonusMode = mobDropBonus == null ? 0
                : mobDropBonus.qualityModeBonus(entity.getKiller(), random.nextDouble());
