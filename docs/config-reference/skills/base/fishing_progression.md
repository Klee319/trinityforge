# skills/base/fishing_progression.yml

出荷config `TrinityForge/src/main/resources/skills/base/fishing_progression.yml` の本文コメント(先頭ヘッダを除く)をここに移設したもの。
...
```
  # Fallback when catch material is absent from fishing_catch table
```
