...
| **M-2** | **手懐けた友好モブの HP をどうするか（計画）** | **2026-08-08 調査完了・下記に設計。実装は未着手** |
| **M-3** | **召喚モブ／ゴーレム（バニラ含む）の攻撃力をどうするか（計画）** | **2026-08-08 調査完了・下記に設計。実装は未着手** |
