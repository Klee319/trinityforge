...
| ID | 内容 | 状態 |
|---|---|---|
| W-146 | 掘削加速のギミックを、採掘ギミックページのように editor の掘削ギミックページで設定できない | 未着手 |
| W-147 | ポーションが醸造できるようになったが、醸造（錬金）スキル経験値が入らない | 未着手 |
| W-148 | エンダーマンで経験値が入らなかった人が場所を移動しても入らなかったらしい。同じ場所狩りの減衰措置のバグ疑い | 調査中（ユーザー判断で**こちらで調査**） |
