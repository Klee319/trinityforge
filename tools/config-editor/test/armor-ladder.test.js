...
// 2026-08-29 W-298: 重装防御系を約10%引き上げたので、金帯以降の理論耐久が約2〜4発伸びた。
const S_THEORY_TARGET = { 0: 12.6, 10: 7.1, 20: 6.6, 30: 10.8, 40: 15.71, 55: 17.40, 70: 18.17, 85: 19.06, 100: 19.73 };
const S_BASELINE_TARGET = { 0: 8.0, 10: 5.0, 20: 4.5, 30: 6.3, 40: 7.6, 55: 11.22, 70: 11.64, 85: 13.59, 100: 14.68 };
...
// 2026-08-29 W-298: 重装防御 +10% に合わせ金帯以降を再測定。
const A_BAND_TARGET = { 0: 5.5, 10: 5.6, 20: 5.1, 30: 8.1, 40: 8.3, 55: 11.02, 70: 11.64, 85: 13.49 };
